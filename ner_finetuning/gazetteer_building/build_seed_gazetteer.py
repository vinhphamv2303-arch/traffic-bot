import argparse
from gazetteer_building_core.build_gazetteer import build_gazetteer

def main():
    ap = argparse.ArgumentParser(description="Build seed gazetteer from reviewed surface forms.")
    ap.add_argument("--reviewed", required=True)
    ap.add_argument("--output", "-o", default="./data/preprocessed/seed_gazetteer")
