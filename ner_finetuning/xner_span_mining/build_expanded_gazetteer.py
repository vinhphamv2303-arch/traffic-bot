import argparse
import sys
from xner_span_mining_core.gazetteer_v2 import build_gazetteer_v2
...
def main():
    ap = argparse.ArgumentParser(description="Build expanded gazetteer from pruned seed gazetteer and reviewed candidates.")
    ap.add_argument("--base-gazetteer-root", required=True)
    ap.add_argument("--reviewed-mined-csv", required=True)
    ap.add_argument("--output", "-o", default="./data/preprocessed/expanded_gazetteer")
