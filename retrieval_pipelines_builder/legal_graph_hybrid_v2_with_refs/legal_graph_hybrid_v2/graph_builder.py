...
def build_graph(
    ...
    for s in sentences:
        ...
        passage_info.setdefault(pid, {
            "passage_id": pid,
            "source_unit_id": s.get("source_unit_id") or pid,
            ...
            "passage_kind": s.get("passage_kind"),
            "effective_from": s.get("effective_from"),
            "ceased_from": s.get("ceased_from"),
            "passage_text": s.get("passage_text") or s.get("context_text") or s.get("text"),
    ...
    for pid, info in sorted(passage_info.items()):
        nodes.append(node(
            ...
            "passage",
            passage_id=pid,
            source_unit_id=info.get("source_unit_id") or pid,
            package_id=info.get("package_id"),
            document_id=info.get("document_id"),
            ...
            passage_kind=info.get("passage_kind"),
            effective_from=info.get("effective_from"),
            ceased_from=info.get("ceased_from"),
            passage_text=info.get("passage_text"),
