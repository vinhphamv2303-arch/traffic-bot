...
def main() -> None:
    ...
    parser.add_argument("--retriever-script", default="legal_linearrag_retriever/retrieve.py")
    parser.add_argument("--index-dir", default="data/preprocessed/linearrag_index_hybrid_v2_full_dense")
    parser.add_argument("--gazetteer-root", default="data/preprocessed/gazetteers_v2")
