import argparse
from legal_entity_vocab.aggregate import aggregate_entity_vocab

def main():
    ap = argparse.ArgumentParser(description="Aggregate LLM entity mentions into reviewable surface-form vocabulary.")
    ap.add_argument("--entity-mentions", required=True, help="Path to all_entity_mentions.jsonl")
    ap.add_argument("--output", "-o", default="./data/preprocessed/entity_vocab_v1")
